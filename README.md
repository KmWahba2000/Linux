...
ls /etc/yum.repos.d/                                              # List configured repos
sudo vi /etc/yum.repos.d/<repo-name>.repo                         # Edit a repo file
sudo dnf install dnf-plugins-core                                 # Required for config-manager
